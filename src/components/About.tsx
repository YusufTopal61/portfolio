      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Over <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">mij</span>
          </h1>
            ...
            <div className="bg-gradient-to-br from-purple-600 to-pink-600 p-1 rounded-2xl">
              <div className="bg-slate-900 rounded-2xl p-8">
                ...
                <div className="space-y-4">
                  <div>
                    <span className="text-purple-400 font-medium">Naam:</span>
                    <span className="text-gray-300 ml-2">Yusuf Topal</span>
                  </div>
                  <div>
                    <span className="text-purple-400 font-medium">Leeftijd:</span>
                    <span className="text-gray-300 ml-2">19 jaar</span>
                  </div>
                  <div>
                    <span className="text-purple-400 font-medium">Locatie:</span>
                    <span className="text-gray-300 ml-2">Amsterdam-Noord</span>
                  </div>
                  <div>
                    <span className="text-purple-400 font-medium">Opleiding:</span>
